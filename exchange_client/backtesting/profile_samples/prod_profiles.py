...
# Exported from profile: bullet_perps
{
    "display_name": "bullet_v6_vol_pullback_adxAI",
...
# Exported from profile: short_trend_v16
{
    ...
    "use_trend_invalidation_exit": True,
    "trend_invalidation_indicators": "trend",
    "min_position_age_for_trend_check": 70,
    "trading_hours": [],
    "trend_indicators": [
        {"type": "ema_slope", "params": {"ema": 20, "direction": "falling", "min_slope_pct": 0.02, "hard_stop": True}},
        {"type": "ema_slope", "params": {"ema": 50, "direction": "falling", "min_slope_pct": 0}},
        {"type": "adx_regime", "params": {"min_adx": 12, "max_adx": 25, "hard_stop": True}},
    ],
    "min_indicators_required": 2,
    "entry_indicators": [
        {"type": "ema_slope", "params": {"ema": 20, "direction": "falling", "min_slope_pct": 0, "max_slope_pct": 0.3, "hard_stop": True}},
        ...
        {"type": "price_above_vwap", "params": {"min_gap_pct": -8, "max_gap_pct": 0.5}},
        {"type": "reversal_candle", "params": {"pattern": "bear_close", "max_close_pct": 0.45, "require_bull": False, "require_bear": False, "max_rise_from_close_pct": 0.6}},
        {"type": "bollinger_bands", "params": {"band": "lower", "mode": "pct_b", "min_pct_b": 0.35, "max_pct_b": 0.85, "hard_stop": True}},
        {"type": "volume_spike", "params": {"min_ratio": 0, "max_ratio": 0.5, "hard_stop": True}},
    ],
    "min_entry_indicators_required": 5,
},
