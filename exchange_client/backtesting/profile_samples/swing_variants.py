...
SWING_VARIANTS = {
    ...
    # ============ V16 ITERATION (Jul 21 2026) — around p3_v11 ================
    # 2y candle-mode baseline: p3_v11 best of family (382T, +19.6% gross, 1.08x,
    # 5/9 quarters) but +0.0514%/trade — below the 0.0876% break-even. Loses the
    # two CHOP quarters. Selection: net avg/trade @0.10% fee + quarterly hit rate.
    # Every variant keeps p3_v11's entry/trend logic; one lever moves at a time.
    "p3_v16_base": {
        **_SWING_BASE,
        "symbols": "['SOL_USDC', 'BTC_USDC', 'ETH_USDC','XRP_USDC','ZEC_USDC','BNB_USDC']",
        "take_profit_pct": 3.5,
        ...
        "trend_invalidation_indicators": 'trend',
        "min_position_age_for_trend_check": 0,
        "trend_indicators": [{'type': 'ema_cross', 'params': {'hard_stop': True}}, {'type': 'ema_slope', 'params': {'ema': 20, 'direction': 'rising', 'min_slope_pct': 0.02, 'hard_stop': True}}, {'type': 'rsi_range', 'params': {'min': 52, 'max': 63, 'invert': True, 'hard_stop': True}}],
        "min_indicators_required": 3,
        "entry_indicators": [{'type': 'adx_regime', 'params': {'min_adx': 22, 'max_adx': 40}}, {'type': 'rsi_range', 'params': {'min': 30, 'max': 50, 'invert': True, 'hard_stop': True}}, {'type': 'volume_spike', 'params': {'min_ratio': 1.2, 'max_ratio': 8.0}}],
        "min_entry_indicators_required": 3,
    },
    "p3_v16_exitmode": {
        **_SWING_BASE,
    ...
    "p3_v16_tightzone": {
        **_SWING_BASE,
        ...
        "trend_indicators": [{'type': 'ema_cross', 'params': {'hard_stop': True}}, {'type': 'ema_slope', 'params': {'ema': 20, 'direction': 'rising', 'min_slope_pct': 0.02, 'hard_stop': True}}, {'type': 'rsi_range', 'params': {'min': 52, 'max': 63, 'invert': True, 'hard_stop': True}}],
        "min_indicators_required": 3,
        "entry_indicators": [{'type': 'adx_regime', 'params': {'min_adx': 25, 'max_adx': 40}}, {'type': 'rsi_range', 'params': {'min': 32, 'max': 46, 'invert': True, 'hard_stop': True}}, {'type': 'volume_spike', 'params': {'min_ratio': 1.5, 'max_ratio': 8.0}}],
        "min_entry_indicators_required": 3,
    },
}
