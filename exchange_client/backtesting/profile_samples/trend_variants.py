...
TREND_VARIANTS = {
    ...
    "tf_baseline_default": {
        **_TF_BASE,
        "trend_indicators": [
            {"type": "rsi_range",  "params": {"min": 30, "max": 65, "invert": True}},
        ...
        "entry_indicators": [
            ...
            {"type": "rsi_threshold",   "params": {"period": 14, "min_value": 52, "use_momentum": True, "early_threshold": 48, "hard_stop": True}},
    ...
    "tf_v1_lower_rsi_entry": {
        **_TF_BASE,
        ...
        "entry_indicators": [
            ...
            {"type": "ema_slope",       "params": {"ema": 20, "direction": "rising",      "min_slope_pct": 0.02}},
            {"type": "ema_slope",       "params": {"ema": 50, "direction": "not_falling", "min_slope_pct": 0.01}},
            {"type": "rsi_threshold",   "params": {"period": 14, "min_value": 44, "use_momentum": True, "early_threshold": 40, "hard_stop": True}},
            {"type": "rsi_overbought",  "params": {"min_value": 65, "hard_stop": True}},
            {"type": "price_vs_vwap",   "params": {}},
            {"type": "bollinger_bands", "params": {"band": "lower", "mode": "pct_b", "max_pct_b": 0.70, "hard_stop": True}},
            {"type": "bollinger_bands", "params": {"band": "upper", "mode": "pct_b", "min_pct_b": 0.30, "hard_stop": True}},
    ...
    # -------------------------------------------------------------------------
    # V2: Replace 60m EMA slope gate with 60m RSI range gate
    # Core insight: 60m EMA20 was 4-6% above price for 10+ hours after the
    # crash, creating a multi-hour blackout. But 60m RSI recovered to 30+
    # within 4-5 hours. Swapping the EMA slope check for a RSI range check
    # means the HTF gate clears much faster after a bottom.
    # Still requires 60m RSI in a "reasonable" range (not extreme either way).
    # -------------------------------------------------------------------------
    "tf_v2_60m_rsi_gate_not_ema": {
        **_TF_BASE,
        "trend_indicators": [
            # 60m RSI must be in 28-65: not a free-falling crash, not overbought
            # This clears as soon as the hourly RSI stabilises, not EMA
            {"type": "rsi_range", "params": {"min": 28, "max": 65}},
            # Keep the overbought block
            {"type": "rsi_overbought", "params": {"min_value": 65, "hard_stop": True}},
        ],
        "min_indicators_required": 2,
        "entry_indicators": [
            {"type": "price_vs_ema",    "params": {"ema": 20, "min_gap_pct": -0.5, "max_gap_pct": 1.5}},
            {"type": "ema_slope",       "params": {"ema": 20, "direction": "rising", "min_slope_pct": 0.02}},
            # EMA50 slope removed — too laggy post-crash
            {"type": "rsi_threshold",   "params": {"period": 14, "min_value": 48, "use_momentum": True, "early_threshold": 44, "hard_stop": True}},
            {"type": "rsi_overbought",  "params": {"min_value": 65, "hard_stop": True}},
            {"type": "price_vs_vwap",   "params": {}},
            {"type": "bollinger_bands", "params": {"band": "lower", "mode": "pct_b", "max_pct_b": 0.70, "hard_stop": True}},
            {"type": "bollinger_bands", "params": {"band": "upper", "mode": "pct_b", "min_pct_b": 0.30, "hard_stop": True}},
        ],
        "min_entry_indicators_required": 5,  # one less since EMA50 removed
    },
