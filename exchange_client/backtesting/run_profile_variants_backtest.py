...
VARIANT_SETS = {
    "range": (RANGE_VARIANTS,    ["SOL_USDC", "ETH_USDC", "BTC_USDC","HYPE_USDC","SUI_USDC"]),
    "mr":    (MEAN_REV_VARIANTS,  ["SOL_USDC", "ETH_USDC", "BTC_USDC","HYPE_USDC","SUI_USDC"]),
    "trend": (TREND_VARIANTS,  ["SOL_USDC", "ETH_USDC", "BTC_USDC","HYPE_USDC"]),
    "4hr_swing": (SWING_VARIANTS, ["SOL_USDC", "ETH_USDC", "BTC_USDC","HYPE_USDC","SUI_USDC"]),
    "mr_short":    (MEAN_REV_SHORT_VARIANTS,  ["SOL_USDC", "ETH_USDC", "BTC_USDC","HYPE_USDC","SUI_USDC"]),
